...
import { useAuth } from "@/hooks/use-auth"; // Cambiado a la ruta estándar de tu proyecto
import { User, Lock, Loader2 } from "lucide-react"; 

export default function Login() {
  const { loginMutation } = useAuth(); // Esto es lo que causaba el error si el hook no estaba bien importado
        ...
        <div className="hidden md:flex w-1/2 relative bg-gradient-to-br from-emerald-600 to-blue-700 flex-col justify-center p-12 text-white">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm leading-relaxed text-blue-50 opacity-90 border-l-4 border-emerald-400 pl-4">
              Institución cristiana abocada a mostrar el amor de Dios al prójimo a través de la acción social.
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="space-y-2">
                    ...
                    <div className="relative text-slate-400">
                        ...
                        <input 
                            ...
                            className="w-full pl-10 h-12 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-slate-800"
                            placeholder="Usuario"
                        />
                    </div>
                </div>
                ...
                <button 
                    ...
                    className="w-full h-12 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl shadow-lg transition-all active:scale-95 flex items-center justify-center disabled:opacity-70"
                >
