...
export default function Login() {
  ...
  const onSubmit = async (data: any) => {
    try {
      // FIX DEL ERROR 400: Enviamos username y password por separado como strings
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-100 p-4 font-sans">
      <div className="flex w-full max-w-4xl overflow-hidden rounded-[2.5rem] shadow-2xl bg-white h-[580px]">
        ...
        {/* LADO IZQUIERDO: El diseño original que te gustaba */}
        ...
        <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div>
                    <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1 block ml-1">Contraseña</label>
                    <div className="relative">
